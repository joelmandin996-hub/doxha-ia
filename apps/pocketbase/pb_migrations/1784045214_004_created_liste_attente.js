...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_7702365234",
    "indexes": ["CREATE UNIQUE INDEX idx_liste_attente_composite ON liste_attente (evenement_id, participant_id)"],
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_7702365234");
