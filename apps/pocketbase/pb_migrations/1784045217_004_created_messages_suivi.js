...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_4591501537",
    "indexes": ["CREATE INDEX idx_messages_suivi_evenement_id ON messages_suivi (evenement_id)", "CREATE INDEX idx_messages_suivi_date_envoi ON messages_suivi (date_envoi)"],
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_4591501537");
